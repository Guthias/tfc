...
<summary><strong> 🔰 Iniciando o projeto</strong></summary><br />
  ...
  1. Clone o repositório
	* `git clone https://github.com/tryber/sd-018-b-trybe-futebol-clube.git`.
- Entre na pasta do repositório que você acabou de clonar:
	* `cd sd-018-b-trybe-futebol-clube`
...
- Você deve criar uma branch no seguinte formato: `nome-de-usuario-nome-do-projeto`
	* Exemplo: `git checkout -b maria-sd-018-b-trybe-futebol-clube`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-018-b-trybe-futebol-clube`
...
- `sd-018-b-trybe-futebol-clube/app/backend/package.json`
...
<details>
  ...
  - Vá até a página DO SEU Pull Request, adicione a label de "code-review" e marque seus colegas
    ...
    - No menu à direita, clique no *link* "Reviewers" e digite students, selecione o time tryber/students-sd-018-b
